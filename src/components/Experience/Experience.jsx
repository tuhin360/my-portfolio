    ...
    <div className="w-full max-w-7xl mx-auto mt-16 md:mt-24 px-4 mb-40 ">
      ...
      <div className="relative">
        ...
        {experiences.map((exp, index) => (
          <div
            key={index}
            className={`mb-16 flex flex-col sm:flex-row items-start sm:items-center ${
          ...
          >
            ...
            {/* Experience Card */}
            <div className="bg-white/5 backdrop-blur-md border border-purple-500/10 p-6 rounded-xl shadow-xl text-left sm:w-1/2 mt-6 sm:mt-0 sm:ml-8 sm:mr-8 transition-transform duration-300 hover:scale-[1.03] hover:shadow-purple-500/40">
              <h3
              ...
              <p
                className="text-purple-400 font-medium mt-1"
                data-aos="fade-in"
              >
                {exp.company}
              </p>
              <p className="text-sm text-gray-400 mb-3" data-aos="fade-in">
                {exp.date}
              </p>
              <p className="text-gray-300 leading-relaxed" data-aos="fade-in">
                {exp.description}
              </p>
            </div>
          </div>
